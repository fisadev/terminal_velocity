...
MAX_MOVES_TO_ASTEROID = 1    # movimientos maximos hacia el prox asteroide recordado
...
class BotLogic:
    ...
    def initialize(self, player_name, map_radius, players, turns, home_base_positions):
        ...
        if self.map_radius > 24:
            self.MAX_MOVES_IN_SEXTANT = 4
            self.SEXTANT_RADIUS_FACTOR = 0.75
        elif self.map_radius > 15:
            self.MAX_MOVES_IN_SEXTANT = 3
            self.SEXTANT_RADIUS_FACTOR = 0.7
        # Punto fijo de Fry
